...
plot "data.csv" using 0:3 lw 3 dt "." with lines title "SCO - flow conformance",\
     "data.csv" using 0:4 lw 3 dt "-" with lines title "SCO/Intent - flow conformance",\
	 "data.csv" using 0:2 lw 3 dt "._" with lines title "SCO/Intent - Intent conformance",\
